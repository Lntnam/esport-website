...
@section('content')
    <div class="container">
        <div class="col-lg-12">
            ...
            <div class="row">
                <h3 id="live_heading" data-editable="true">{!! ContentBlock::output($view_name, 'live_heading') !!}</h3>
            ...
            <div class="row">
                <h3 id="upcoming_heading"
                    data-editable="true">{!! ContentBlock::output($view_name, 'upcoming_heading') !!}</h3>
            ...
            <div class="row">
                <h3 id="recent_heading"
                    data-editable="true">{!! ContentBlock::output($view_name, 'recent_heading') !!}</h3>
            ...
            <div class="row">
                <h4 id="subscribe_heading"
                    data-editable="true">{!! ContentBlock::output($view_name, 'subscribe_heading') !!}</h4>
