        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    ...
                    <div id="intro_sub_header"
                         contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.intro_sub_header') !!}</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                <h2 class="section-heading" id="heading_dota2" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.heading_dota2') !!}</h2>
                <div id="intro_dota2" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.intro_dota2') !!}</div>
                <ul class="list-inline intro-call-to-actions">
                    <li>
                        <a class="btn btn-success btn"
                           href="{!! URL::route('front.fixture.index') !!}"><span
                                    class="network-name">@lang('pages.fixtures')</span></a>
                    </li>
                    <li>
                        <a class="btn btn-info btn" href="https://gaming.youtube.com/c/NextGenDOTA2VN"
                           target="_blank"><span class="network-name">@lang('pages.streaming')</span></a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                <h2 class="section-heading" id="heading_lol" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.heading_lol') !!}</h2>
                <div id="intro_lol" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.intro_lol') !!}</div>
                <ul class="list-inline intro-call-to-actions">
                    <li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                ...
                <h2 class="section-heading" id="heading_nextgen" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.heading_nextgen') !!}</h2>
                <div id="intro_nextgen" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.intro_nextgen') !!}</div>
                <ul class="list-inline intro-call-to-actions">
                    <li>
                        <a class="btn btn-success btn" href="javascript:void(0)"><span
                                    class="network-name">@lang('pages.the_management')</span></a>
                    </li>
                    <li>
                        <a class="btn btn-info btn" href="javascript:void(0)"><span
                                    class="network-name">@lang('pages.our_missions')</span></a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-5 col-lg-offset-2 col-sm-6">
...
<div class="banner">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2 id="heading_subscription" contenteditable="{{ !empty(session('admin_edit_page')) ? 'true' : 'false' }}">{!! ContentBlock::output('home.heading_subscription') !!}</h2>
            </div>
            <div class="col-lg-6">
                <form role="form" class="form-inline" method="post"
                      action="{!! URL::route('front.subscription.create') !!}">
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-success input-lg">@lang('contents.btn_subscribe')</button>
...
<script type="text/javascript">
    ...
    @if (!empty(session('admin_edit_page')))
        CKEDITOR.inline( 'heading_subscription' );
    @endif
</script>
</body>
</html>
