                                                ...
                                                <table align="left" width="100%" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td class="mcnImageContent" width="600" valign="top"
                                                            style="width: 600px; padding: 0 9px;text-align:center;">


                                                            <img align="center" alt=""
                                                                 src="https://gallery.mailchimp.com/59a9a5aee257480d4f3cbe81e/images/bb2720fc-03fd-4929-ba2c-69c7f9e7ede9.jpg"
                                                                 width="251"
                                                                 style="max-width:251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                                                 class="mcnImage">
                                                ...
                                                <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" class="mcnTextContent" width="600"
                                                            style="width: 600px; padding: 0 18px 9px;">

                                                            <h2 class="null">Upcoming matches for the next 3 days:</h2>
                                                            <br>
                                                            <table width="100%" border="0" cellpadding="4"
                                                                   cellspacing="0" style="border: 1px solid lightgrey">
                                                                <tbody>
                                                                @foreach ($matches as $match)
                                                                    <tr>
                                                                        <td>On <strong>{{ $match->date }}</strong></td>
                                                                        <td>{{ $match->tournament->short }}</td>
                                                                        <td>@if ($match->opponent != null)
                                                                                against
                                                                                <strong>{{ $match->opponent->name }}</strong>
                                                                            @else
                                                                                against `TBD`
                                                                            @endif</td>
                                                                        <td align="center">Bo {{ $match->games }}</td>
                                                                        <td align="center">at
                                                                            <strong>{{ $match->time }}</strong></td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            For more fixtures &amp; results, visit&nbsp;<a
                                                                    ...
                                                                    target="_blank">http://www.next-gen.vn/fixtures</a><br>
                                                            <br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" class="mcnTextContent"
                                                            ...
                                                            *|HTML:LIST_ADDRESS_HTML|* *|END:IF|*<br>
                                                            ...
                                                            You can <a href="*|UPDATE_PROFILE|*">update your
                                                                preferences</a> or <a href="*|UNSUB|*">unsubscribe from
                                                                this list</a><br>
                                                            <br>
