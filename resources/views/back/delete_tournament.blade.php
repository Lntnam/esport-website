...
@section('title', trans('pages.delete', ['model'=>'tournament']))

@section('page-heading', trans('pages.delete', ['model'=>'tournament']))
...
@section('breadcrumbs', Breadcrumbs::render('delete_tournament', $model))
...
@section('content')
    ...
    @if ($deletable)
        <div class="row">
            <div class="col-lg-6">
                <form role="form" method="post" action="{{ route('back.tournament.doDelete') }}">
                    {{ csrf_field() }}
